...
const STEPS = [
    ...
    },
    {
        ...
        description: "We will scrape data from here to train your Ai assistant.",
        icon: Globe,
        placeholder: "e.g. https://nexus.com",
        type: "url",
    ...
    },
    {
        ...
        description: "Add any other links or Help docs to insert into your Ai assistant.",
        icon: LinkIcon,
        placeholder: "e.g. https://nexus.com/help/docs...",
        type: "textarea",
        badge: "Optional",
            ...
            <div className="fixed top-0 left-0 w-full h-1 bg-white/5">
                ...
                {isSubmitting ? (
                    ...
                    <h2 className='text-2xl font-medium text-white mb-2'>
                        Storing your organization data...
                    </h2>
                    ...
                    >
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-medium text-indigo-400 uppercase tracking-wider bg-indigo-500/10 border border-indigo-500/10 rounded-full px-2 py-0.5 text-center">
                                ...
                                <Button 
                                    ...
                                    className={cn(
                                        ...
                                        !isStepValid 
                                            ...
                                            : "bg-white text-black hover:bg-zinc-200 hover:shadow-lg hove:shadow-white/10"
                                    )}
                                >
