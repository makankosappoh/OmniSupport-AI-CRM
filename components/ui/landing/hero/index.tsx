        ...
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
            <div className="max-w-6xl mx-auto text-center relative z-20">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-8 animate-float">
                    ...
                    <span className="text-xs text-zinc-300 tracking-wide font-light">Welcome to our platform</span>
                </div>

                <h1 className="text-5xl md:text-7xl font-medium tracking-light text-white mb-6 leading-[1.1]">
                    Human Friendly Support AI,
                    <br />
                    <span className="text-zinc-500">for businesses and developers.</span>
                </h1>

                <p className="text-lg md:text-xl text-zinc-400 font-light mb-10 max-w-2xl mx-auto leading-relaxed">
                    Instantly resolve customer questions with an assistant that reads your docs and speaks with empathy. No robotic replies, just profecient answers.
                </p>
                    ...
                    <div className="flex flex-col h-125 md:h-150 w-full bg-[#0a0a0e] rounded-xl overflow-hidden">
                        <div className="h-14 border-b border-white/5 flex items-center justify-between px-4 bg-[#0E0E12] shrink-0">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-zinc-400 font-medium">OmniSupport AI</span>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-zinc-950/30">
                            ...
                            <div className="flex w-full flex-col items-start">
                                <div className="flex max-w-[85%] gap-3 flex-row">
                                    <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 border-black/10 bg-black/20">
                                        <Image
                                            src="https://images.unsplash.com/vector-1786096370140-b01477c0599d?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                            alt="Support Agent"
                                            width={40}
                                            height={40}
                                ...
                                <div className="flex max-w-[85%] gap-3 flex-row-reverse">
                                    ...
                                    <div>
                                        <div className="p-4 rounded-2xl text-sm leading-relaxed shadow-sm bg-zinc-800 text-zinc-200 rounded-tr-sm">
                                            I need some information about OmniSupport AI.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <button className="h-8 w-8 rounded-lg bg-zinc-800 flex item-center justify-center text-zinc-500 cursor-default">
