    ...
    className='py-32 px-6 max-w-6xl mx-auto text-center'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto'>
            <div className='p-8 rounded-3xl border border-white/5 bg-zinc-900/20 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors'>
                ...
                <div className='text-4xl font-medium text-white tracking-light mb-6'>
                ...
                <ul className='space-y-3 mb-8 text-sm text-zinc-300 font-light w-full'>
                    ...
                    <li className='flex items-center gap-3'>
                        <Check className='w-4 h-4 text-zinc-600' /> Community support & Updates
                    </li>
                </ul>
        ...
        <div className='p-8 relative overflow-hidden rounded-3xl border border-white/10  bg-white/3 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors'>
                <div className='absolute top-0 right-0 px-4 py-1 bg-white/10 rounded-bl-xl'>Best</div>
                <div className='text-sm font-medium text-indigo-400 mb-2'>Pro</div>
                <div className='text-4xl font-medium text-white tracking-light mb-6'>
                $20 <span className='text-lg text-zinc-600 font-light'>/month</span>
                </div>
                <ul className='space-y-3 mb-8 text-sm text-zinc-300 font-light w-full'>
                    <li className='flex items-center gap-3'>
                        <Check className='w-4 h-4 text-indigo-400' /> Unlimited conversations/month
                    </li>
                    <li className='flex items-center gap-3'>
                        <Check className='w-4 h-4 text-indigo-400' /> Unlimited Knowledge Source
                    </li>
                    <li className='flex items-center gap-3'>
                        <Check className='w-4 h-4 text-indigo-400' /> Community support & Updates
                    </li>
                    <li className='flex items-center gap-3'>
