    ...
    return (
        ...
        className="py-24 border-t border-white/5 bg-black/20">
            <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16"> 
                ...
                <h2 className="text-3xl md:text-4xl font-medium text-white tracking-tight mb-6">Drop-in Simplicity.</h2>
                <p className="text-lg text-zinc-400 font-light leading-relaxed mb-8">
                    No more complex SDK integrations or time-consuming setups. Just add our script tag and you&apos;re ready to go live. We inherit your CSS variables automatically, ensuring the chatbot seamlessly fits with your existing design.
                </p>
                    ...
                    <div className="glass-card rounded-xl p-6 relative">
                        ...
                        <div className="font-mono text-xs md:text-sm leading-7 text-zinc-400">
                            ...
                            <div className="pl-4">
                                ...
                                <span className="text-emerald-400">&quot;https:omnisupport.com/init.js&quot;</span>
                            </div>
                            <div className="pl-4">
